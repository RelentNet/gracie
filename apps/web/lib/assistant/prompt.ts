...
export function buildAssistantSystemPrompt(
  ...
  return [
    ...
    '  every Monday", "remind the team to file notes every Friday"), you may PROPOSE an',
    '  automation with create_automation. Supported types: client_report, portfolio_digest,',
    '  activity_digest, reminder, and client_send (emailing an EXTERNAL client).',
