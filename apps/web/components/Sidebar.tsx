    ...
    <>
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-1">
          ...
          {/* Scrolls on its own when the window is short (large OS/browser zoom) so the
              account card with Sign Out below always stays on screen. */}
          <div className="-mr-2 flex min-h-0 flex-1 flex-col overflow-y-auto overscroll-contain pr-2">
        ...
        <div
          className={`mt-2 flex shrink-0 flex-col gap-3 rounded-lg border p-3 [@media(max-height:860px)]:gap-1 [@media(max-height:860px)]:p-2 ${collapsed ? 'md:p-2' : ''}`}
